...
RUNTIME='1234RUNTIME'
BUILD_ENVIRONMENT='AnotherENVIRONMENT1withSAMEBRANCHNAME'
COMMIT_ID=7035df304135d746c71e92edaea9bd1fc8525646
BUILD_ID=somebuild:99999999999999
...
sh print-message.sh
echo "VERIFY:"
echo "Build page: All sorting scenario."
echo "Deploy page: All sorting scenario."
echo "---------------------------------------------------------------------------------------------------------"